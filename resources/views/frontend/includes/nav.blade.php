<header class="bg-dark">
    <div class="container w-11/12 mx-auto py-4 flex justify-between items-center">
        <a class="text-white hover:text-yellow-600"  href="{{ route('frontend.index') }}">{{ app_name() }}</a>
        <ul class="flex self-center">
            <li class="w-24 text-center p-3 mx-1"><a class="text-white font-semibold  hover:text-yellow-600" href="#">Home</a></li>
            <li class="w-24 text-center p-3 mx-1"><a class="text-white font-semibold  hover:text-yellow-600" href="#">Product</a></li>
            <li class="w-24 text-center p-3 mx-1"><a class="text-white font-semibold  hover:text-yellow-600" href="#">About Us</a></li>
        </ul>
        <div class="flex">
            <button class="bg-transparent text-white font-semibold p-2 border border-green-600 rounded-full w-24">Login</button>
            <button class="bg-green-600 text-white font-semibold  p-2 rounded-full w-24 ml-6">Register</button>
        </div>
    </div>
</header>
